...
export const AREADD = ['ENTRANCE', 'LIVING ROOM 1', 'BALCONY 1', 'MASTER BEDROOM', 'BED ROOM 1', 'BED ROOM 2', 'BED ROOM 3', 'BED ROOM 4', 'BATH ROOM 1', 'BATH ROOM 2', 'BATH ROOM 3', 'BATH ROOM 4', 'KITCHEN', 'DINING ROOM', 'STORE 1', 'STORE 2', 'BALCONY 2', 'BALCONY 3', 'STAIRCASE', 'LIVING ROOM 2', 'BALCONY', 'LIVING ROOM 3', 'FOYER', 'EXTERNAL', 'BATH ROOM', 'UTILITY', 'TERRACE'];
export const ELEMENTDD = ['FLOOR', 'WALL', 'CEILING', 'DOOR', 'WINDOW', 'INTERNAL FIXTURE', 'ROOF', 'EXTERNAL WALL', 'APRON OR DRAIN', 'CARPARK AND CARPORCH', 'M&E', 'FENCE AND GATE'];
